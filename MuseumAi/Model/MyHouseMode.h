...
@interface MyHouseMode : NSObject
...
@property (nonatomic,copy) NSString *gfr;//杨明",
@property (nonatomic,copy) NSString *gyr;// null,
@property (nonatomic,copy) NSString *gfrzjhm;//430122198910102197",
@property (nonatomic,copy) NSString *gyrzjhm;// null,
@property (nonatomic,copy) NSString *xmbh;//200206080001",
@property (nonatomic,copy) NSString *xmmc;//恒宇住宅楼1栋",
