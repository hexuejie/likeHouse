...
- (void)setupImageOfImageViewForIndex:(NSInteger)index
{
    ...
    UIImage *placeHolder = [self placeholderImageForIndex:index];
    if (url)
    {
        [imageView setImageWithURL:url placeholderImage:placeHolder topImageName:_topImageName];
    } else
    {
...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    if (currentIndex >= self.sourceImagesContainerView.subviews.count) {
        targetTemp = CGRectMake(SCREEN_WIDTH, 0, 100, 100);
    }else {
