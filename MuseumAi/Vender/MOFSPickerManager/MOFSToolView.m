...
#define LINE_COLOR kUIColorFromRGB(0xE6E6E6)
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _cancelBar.textColor = kUIColorFromRGB(0x9BA0A7);
        _cancelBar.text = @"取消";
        ...
        _titleBar.textColor = kUIColorFromRGB(0x9BA0A7);
        ...
        _commitBar.textColor = kUIColorFromRGB(0xC0905D);
        _commitBar.text = @"完成";
